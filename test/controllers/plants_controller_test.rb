...
class PlantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create plant" do
    assert_difference('Plant.count') do
      post plants_url, params: { plant: { description: @plant.description, spiecie: @plant.spiecie, string: @plant.string } }
    end
  ...
  test "should update plant" do
    patch plant_url(@plant), params: { plant: { description: @plant.description, spiecie: @plant.spiecie, string: @plant.string } }
